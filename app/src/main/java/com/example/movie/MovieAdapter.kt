...
data class Movie(
    ...
    val overview: String,// 상영
    val release_date: String,// 개봉일
    // val poster_path : Int// 포스터 Url <- Int : drawble에 있는 이미지를 가져다 쓰기 위함
...
class MovieAdapter(val context: Context, val movieList: ArrayList<Movie>) :
    ...
    inner class Holder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(movie: Movie) {
            ...
            //  imgPoster.setImageResource(movie.poster_path) //Glide라이브러리 사용
            //Glide 사용
